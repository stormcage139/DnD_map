...
class DndAdventure(models.Model):
    image = models.ImageField(upload_to="adventure_avatars/", height_field=None, width_field=None, max_length=None,blank=True)
    ...
    heroes = models.ManyToManyField(to="Hero.HeroModel",blank=True,verbose_name='Учавствовашие герои')
    npcs = models.ManyToManyField(to="Hero.NPC",blank=True,verbose_name='Учавствовавшие NPCи')
